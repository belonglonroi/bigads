    ...
    ngOnInit() {
        this.userService._user$.subscribe({
            next: (user) => {
                ...
                this.roleActions = user.userRole.roleActions.map(
                    (e) => e.actionId
                );
            },
        });
                ...
                items: [
                    {
                        ...
                        show:
                            this.roleActions.includes(600) ||
                            this.roleActions.includes(601),
                    },
                    {
                        ...
                        show:
                            this.roleActions.includes(700) ||
                            this.roleActions.includes(701),
                    },
                ],
            },
            {

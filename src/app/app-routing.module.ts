        ...
        RouterModule.forRoot(
            [
                ...
                },
                {
                    ...
                    loadChildren: () =>
                        import(
                            './modules/customer-view/customer-view.module'
                ...
                },
                {
                    ...
                    children: [
                        ...
                        },
                        {
                            ...
                            loadChildren: () =>
                                import(
                                    './modules/services/service.module'
                        ...
                        },
                        {
                            ...
                            loadChildren: () =>
                                import(
                                    './modules/campaigns/campaign.module'
                        ...
                        },
                        {
                            ...
                            loadChildren: () =>
                                import(
                                    './modules/campaign-services/campaign-ad.module'
                                ).then((m) => m.CampaignServicesModule),
                        },
                        {
                            path: 'department',
                            loadChildren: () =>
                                import(
                                    './modules/department/department.module'
                        ...
                        },
                        {
                            path: 'code',
                            loadChildren: () =>
                                import('./modules/code/code.module').then(
                                    (m) => m.CodeModule
                                ),
                        },
                    ],
